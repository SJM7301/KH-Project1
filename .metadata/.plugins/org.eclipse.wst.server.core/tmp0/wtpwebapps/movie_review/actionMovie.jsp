	...
	<div class="container py-4">
		...
		<div class="p-5 mb-4 bg-body-tertiary rounded-3">
		    <div class="container-fluid py-3">
		        <div class="row">
		            <!-- 왼쪽 텍스트 부분 -->
		            <div class="col-md-8">
		                <h1 class="display-5 fw-bold">액션 영화 리뷰 목록</h1>
		                <p class="col-md-8 fs-4">Action Movie_Review List</p>
		            </div>
		    	</div>
			</div>
		</div>
		...
		<div class="row align-items-md-stretch text-center">
			<%
				...
				ResultSet rs2 = null;
				String sql2 = "SELECT * FROM review WHERE r_category = 'Action' ORDER BY r_id DESC";
